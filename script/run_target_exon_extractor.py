...
# bed形式にそろえる
splice_acceptor_single_exon_bed = format_to_single_exon_bed(
...
splice_acceptor_single_exon_bed.to_csv(
    "data/splice_acceptor_single_exon.bed", sep="\t", index=False, header=False
)
splice_donor_single_exon_bed.to_csv(
